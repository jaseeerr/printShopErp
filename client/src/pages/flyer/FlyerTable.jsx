...
const FlyerTable = ({ data }) => {
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-3xl font-bold text-center mb-8">Flyer Pricing Overview</h1>
      <div className="w-full flex flex-wrap">
        <PricingTable title="Size Pricing" items={transformData(data.size || {})} />
        <PricingTable title="GSM Pricing" items={transformData(data.gsm || {})} />
        <PricingTable title="Lamination Pricing" items={transformData(data.lamination || {})} />
      </div>
    </div>
  );
};
